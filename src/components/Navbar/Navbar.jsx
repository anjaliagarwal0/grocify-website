    ...
    <header className={`bg-white fixed top-0 right-0 left-0 z-50 ${isScrolled ? 'drop-shadow-[0_4px_25px_rgba(0,0,0,0.1)]' : ''}`}>
      ...
      <nav className=' max-w-[1400px] mx-auto px-10 py-6 flex justify-between items-center'>
        ...
        <ul className='md:flex items-center gap-x-15 hidden'>
          ...
          <li>
            <a href="#" className='font-semibold traking-wider text-zinc-800 hover:text-orange-500'>About Us</a>
          </li>
          <li>
            <a href="#" className='font-semibold traking-wider text-zinc-800 hover:text-orange-500'>Process</a>
          </li>
          <li>
            <a href="#" className='font-semibold traking-wider text-zinc-800 hover:text-orange-500'>Contact Us</a>
          </li>
        </ul>
